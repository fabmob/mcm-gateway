...
class RequestRelayControllerTest extends RequestRelayITTestCase {
    ...
    private void testHttpRequestWithExpectedResult(String uri, HttpMethod httpMethod,
        ...
        ResponseEntity<String> partnerResponseMocked = createMockedPartnerResponse();

        // mock makecall() operation with a stub object from createMocked function
        doReturn(partnerResponseMocked).when(mockRequestRelayService).processCalls(any(), anyBoolean());
     ...
     * @throws IOException
     */
    private ResponseEntity<String> createMockedPartnerResponse() throws IOException {
