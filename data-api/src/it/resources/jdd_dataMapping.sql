...
INSERT INTO msp.partner_meta (partner_id,partner_type,has_hold,has_no_parking_zone,has_operating_zone,has_parking,has_pref_parking_zone,has_speed_limit_zone,has_station,has_station_status,has_ping,has_vehicle,is_enabled,logo_format,logo_url,"name","operator",primary_color,secondary_color,"type",url,url_webview,price_list_price_list_id) VALUES
('b814c97e-df56-4651-ac50-11525537964f', 'MSP', false, false, false, false, false, false, false, true, true, NULL, NULL, 'PNG', '@MAAS_API_DIRECTORY_ICON@/icon_cityscoot@3x.png', 'Dott', 'Dott', '#0054BB', '#0054BB', 'CARPOOLING', 'https://www.cityscoot.eu/paris/', false, '22808a15-1b7b-4605-9764-3c71a3f05ae4'),
('6c317901-749f-4d7d-82bb-afdc737b26b3', 'MSP',false, false, false, false, false, false, false, true, false, NULL, NULL, 'PNG', '@MAAS_API_DIRECTORY_ICON@/icon_cityscoot@3x.png', 'Dott', 'Dott', '#0054BB', '#0054BB', 'CARPOOLING', 'https://www.cityscoot.eu/paris/', false, '08b05a7e-e027-48ba-8916-83c7ddca8c9e'),
('f6b6d937-dd91-4dd2-99d6-74958ee4e09a','MSP', false, false, false, false, false, false, false, true, false, NULL, NULL, 'PNG', '@MAAS_API_DIRECTORY_ICON@/icon_cityscoot@3x.png', 'Dott', 'Dott', '#0054BB', '#0054BB', 'CARPOOLING', 'https://www.cityscoot.eu/paris/', false, '2d973d40-8e33-4b59-9334-a98bbf0e18c5'),
('28784eb7-de79-434d-a1b6-819ebfd50860','MSP', false, false, false, false, false, false, false, true, false, NULL, NULL, 'PNG', '@MAAS_API_DIRECTORY_ICON@/icon_cityscoot@3x.png', 'Dott', 'Dott', '#0054BB', '#0054BB', 'CARPOOLING', 'https://www.cityscoot.eu/paris/', false, 'dad32a8c-0033-4e49-b6b9-cd051744f699'),
('3eeec675-2da2-421b-9b6c-ed05776b9f64','MSP', false, false, false, false, false, false, false, true, false, NULL, NULL, 'PNG', '@MAAS_API_DIRECTORY_ICON@/icon_cityscoot@3x.png', 'Dott', 'Dott', '#0054BB', '#0054BB', 'CARPOOLING', 'https://www.cityscoot.eu/paris/', false, '50d8c105-8742-4187-b4e8-c67c51a34229');
...
INSERT INTO msp.partner_actions (partner_action_id,"action",is_authentication,is_pagination,is_refresh_authentication,name,selector_id) VALUES
	 ('e222f848-0f53-46fd-97fa-6b1f9f3db265','PING',false,0,0,'test_action','ec0e9a76-f1fe-422c-803b-8332ad957942'),
	 ('2c1a2210-4916-4aaa-8287-7a4d50e93518','PING',false,0,0,'test_action','6d91188b-cee1-4351-b277-713ad0b22955'),
	 ('5e71dcb3-ca60-4a2a-9896-c509ad1ca756','PING',false,0,0,'test_action','7d2449bc-dff9-4a58-8d06-8f5f27dbcf97'),
	 ('7c8f8780-a6fa-495d-8b36-24a20539adca','PING',false,1,0,'CityScoot','1b71f9ee-c8c6-428f-b60d-fffcea67c17b');

INSERT INTO msp.token (token_id,access_token,expire_at,partner_id) VALUES
...
INSERT INTO msp.partner_calls (partner_call_id,is_mocked,"method",nb_calls,execution_order,url,action_id,body_id) VALUES
...
INSERT INTO msp.data_mapper (data_mapper_id,external_field, internal_field,contained_value,default_value,format,is_array,timezone,action_id) VALUES
 ...
 INSERT INTO msp.partner_standard (partner_standard_id,is_active,standard_name ,version_datamapping ,version_standard ,partner_action_id,partner_id,adapter_id) VALUES
...
INSERT INTO msp.cache_param (partner_id, action_type, cache_param_id, soft_ttl, hard_ttl, refresh_cache_delay) VALUES
    ('28784eb7-de79-434d-a1b6-819ebfd50860', 'VEHICLE_SEARCH', '885a4c3d-b459-41d6-b1c1-e30a82ea777b', 20, 30, 15),
