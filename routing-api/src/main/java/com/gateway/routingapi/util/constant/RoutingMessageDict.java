...
public class RoutingMessageDict {
    ...
    public static final String MSP_ACTIONS_NAME = "mspActionsName";
    public static final String DEFAULT_ADAPTER_NAME = "default-adapter";
    public static final String GENERIC_ADAPTER_NAME = "genericAdapter";
    public static final String ADAPT = "adapt";

    public static final String NO_ACTIVE_ACTION_FOUND = "no active version of action {} found in standards for msp({})";
