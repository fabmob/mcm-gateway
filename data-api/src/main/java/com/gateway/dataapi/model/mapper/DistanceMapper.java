...
public interface DistanceMapper {
     ...
     */
    DistanceDTO mapEntityToDto(Distance source);
     ...
     */
    List<DistanceDTO> mapEntityToDto(List<Distance> source);
     ...
     */
    List<Distance> mapDtoToEntity(List<DistanceDTO> source);
     ...
     */
    Distance mapDtoToEntity(DistanceDTO source);
}
