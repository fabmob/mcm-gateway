...
public class AdapterMessageDict {
    ...
    public static final String CANNOT_PARSE_TO_GATEWAY_DTO = "Cannot parse to Gateway DTO : {dto}";

    public static final String ACTION_PLACEHOLDER = "action";

    public static final String UNKNOWN_ACTION = "The Gateway does not  know / support this action : {" + ACTION_PLACEHOLDER + "}";

    public static final String UNRECOGNIZED_FUNCTION = "Unrecognized formatting function : check field 'format' of dataMapper with dataMapperId = {dataMapperId}";

    public static final String DATA_MAPPER_ID = "dataMapperId";

    public static final String CANNOT_PARSE = "Error parsing PARTNER response: ";
    ...
    public static final String MISSING_EXTERNAL_FIELD = "Data mapper with id : {0} has no 'externalField' or 'DefaultValue' ";
    ...
    public static final String PARTNER_CALL_ID = "partnerCallId";
    ...
    public static final String PRE_PROCESS = "Pre process value : {finalValue}";
    ...
    public static final String PARTNER_ACTION_WITH_THIS_PARTNER_META_ID_IS_NOT_FOUND = "PartnerAction with PartnerMeta id {0} ";
