...
@Getter
@Setter
@Table(name = "partner_actions", schema = "msp")
public class PartnerActions implements java.io.Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @Column(name = "partner_action_id", unique = true, nullable = false)
